...
BALATRO_INPUT_FILE=input/quick_start.txt cargo run --release --quiet
...
BALATRO_INPUT_FILE=input/skip_small_blind.txt cargo run --release --quiet
...
BALATRO_INPUT_FILE=input/complete_ante.txt cargo run --release --quiet
...
BALATRO_INPUT_FILE=input/deck_selection.txt cargo run --release --quiet
...
BALATRO_INPUT_FILE=input/stake_selection.txt cargo run --release --quiet
...
BALATRO_INPUT_FILE=input/mixed_strategy.txt cargo run --release --quiet
